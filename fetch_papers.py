...
if __name__ == "__main__":
  ...
  parser.add_argument('--search-query', type=str,
                      default='cat:cs.CV+OR+cat:cs.AI+OR+cat:cs.LG+OR+cat:cs.CL+OR+cat:cs.NE+OR+cat:stat.ML+OR+cat:cs.CC+OR+cat:cs.CY+OR+cat:cs.CR+OR+cat:cs.DB+OR+cat:cs.DS+OR+cat:cs.DC+OR+cat:cs.HC+OR+cat:cs.IR+OR+cat:cs.MA',
